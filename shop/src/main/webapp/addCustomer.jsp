...
<body>
	...
	<!--  고객가입 Form -->
	<form action="<%=request.getContextPath()%>/idAddAction.jsp"
		method="post">
		<table border="1">
			<tr>
				<td>customerId</td>
				<td><input type="text" name="customerId" id="customerId"
					readonly="readonly" value="<%=ckId%>"> <!-- 아이디값이 넘어옴 --></td>
			</tr>
			<tr>
				<td>customerPass</td>
			...
			<tr>
				...
				<td>주소: <input type=text name="addr" id="addr"
					readonly='readonly'>
					<button type="button" id="customerAddrBtn">주소검색</button>
			</tr>
			<tr>
				<td></td>
				<td>상세주소 : <input type=text name="detailAddr" id="detailAddr"></td>
			</tr>
			<tr>
