...
<body>
	...
	<h1>상품관리</h1>
	<div>
	<form action="<%=request.getContextPath()%>/addGoodsForm.jsp">
		<table border="1">
			<thead>
				<tr>
					<th>NO</th>
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="<%=request.getContextPath()%>/admin/adminGoodsOne.jsp?goodsNo=<%=goods.getGoodsNo()%>"><%=goods.getGoodsName()%></a></td>
