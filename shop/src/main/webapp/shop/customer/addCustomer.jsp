...
<body>
	<div class="container">
		<!--  id ck Form -->
		<h1>zebook 고객 회원가입</h1>
		<form action="<%=request.getContextPath()%>/shop/customer/idCheckAction.jsp"
			method="post">
			<div class="form-group">
				<label for="idcheck">ID 체크 :</label> 
				<input type="text" name="ckId" class="form-control" placeholder="ID를 입력해주세요">
		...
		<!--  고객가입 Form -->
		<form action="<%=request.getContextPath()%>/shop/customer/idAddAction.jsp"
			method="post">
			<div class="form-group">
				<label for="customerId">customerId :</label> <input type="text"
					name="customerId" id="customerId" class="form-control"
					readonly="readonly" value="<%=ckId%>">
				<!-- 아이디값이 넘어옴 -->
			</div>
			<div class="form-group">
				<label for="customerPass">customerPass :</label> <input
					type="password" name="customerPass" id="customerPass"
					class="form-control">

			</div>
			<div class="form-group">
				<label for="customerName">customerName :</label> <input
			...
			<label for="customerAddress">customerAddress</label> <br/>
			<div class="form-group row">
			<div class="col-6">
			주소 : <input type="text" name="addr" id="addr" class="form-control" readonly="readonly">
			<button type="button" id="customerAddrBtn" class="btn btn-light">주소검색</button>
			</div>
			<div class="col-6">
			상세주소 : <input type=text name="detailAddr" id="detailAddr" class="form-control">
			
			</div>
			</div>
			
			<div class="form-group">
			<label for="customerTelephone">customerTelephone :</label> 
	...
	<script>
		$('#customerAddrBtn').click(function() {
