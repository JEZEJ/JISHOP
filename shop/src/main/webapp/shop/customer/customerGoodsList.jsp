...
<body>
	...
	<script src="<%=request.getContextPath()%>/shop/js/jquery-3.3.1.min.js"></script>
	<script src="<%=request.getContextPath()%>/shop/js/jquery-ui.js"></script>
	<script src="<%=request.getContextPath()%>/shop/js/popper.min.js"></script>
	<script src="<%=request.getContextPath()%>/shop/js/bootstrap.min.js"></script>
	<script src="<%=request.getContextPath()%>/shop/js/owl.carousel.min.js"></script>
	<script src="<%=request.getContextPath()%>/shop/js/jquery.magnific-popup.min.js"></script>
	<script src="<%=request.getContextPath()%>/shop/js/aos.js"></script>

	<script src="<%=request.getContextPath()%>/shop/js/main.js"></script>
