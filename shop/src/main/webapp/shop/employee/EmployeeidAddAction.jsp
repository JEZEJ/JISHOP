...
<%
	...
	String employeeAddress = request.getParameter("addr");
	String employeeDetailAddress = request.getParameter("detailAddr");
	String employeeTelephone = request.getParameter("employeeTelephone");
	...
	paramEmployee.setEmployeeAddress(employeeAddress);
	paramEmployee.setEmployeeDetailaddress(employeeDetailAddress);
	paramEmployee.setEmployeeTelephone(employeeTelephone);
